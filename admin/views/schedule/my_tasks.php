            ...
            <div class="col">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="?act=hdv-chi-tiet-tour&id=<?= $schedule_id ?>">
                ...
                <p class="text-muted">Danh sách công việc cần thực hiện cho tour này</p>
            </div>
            <div class="col-auto">
                    ...
                    <div class="card border-top-0 rounded-0">
                        <div class="card-body">
                            <?php if (!empty($tasks)): ?>
                                ...
                                <div class="task-card card mb-3 border-left-thick" style="border-left: 4px solid #0d6efd;">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-start">
                                            <div class="flex-grow-1">
                                                ...
                                                <div class="row mt-3">
                                                    ...
                                                    <div class="col-md-3">
                                                        <p class="mb-1 text-muted small">
                                                            <i class="fas fa-map-marker-alt"></i> <strong>Địa điểm:</strong>
                                                        </p>
                                                        <p class="mb-0">
                                                    ...
                                                    <div class="col-md-3">
                                                        <p class="mb-1 text-muted small">
                                                            <i class="fas fa-user"></i> <strong>Người phụ trách:</strong>
                                                        </p>
                                                        <p class="mb-0">
                    ...
                    <div class="card border-top-0 rounded-0">
                        <div class="card-body">
                            ...
                            <?php if (!empty($guidance_tasks)): ?>
                                ...
                                <div class="card mb-3 border-start border-success" style="border-left-width: 4px !important;">
                                    <div class="card-body">
                    ...
                    <div class="card border-top-0 rounded-0">
                        <div class="card-body">
                            ...
                            <?php if (!empty($special_notes)): ?>
                                ...
                                <div class="card mb-3 border-start border-warning" style="border-left-width: 4px !important; background-color: #fffbf0;">
                                    <div class="card-body">
                                        <h6 class="card-title mb-2">
                                        ...
                                        <small class="text-muted">
                                            <i class="fas fa-clock"></i> <?= htmlspecialchars($task['time']) ?> |
                                            <i class="fas fa-user"></i> <?= htmlspecialchars($task['responsible']) ?>
                                        </small>
                                    </div>
                                </div>
                                <?php endforeach; ?>
        ...
        <div class="col-md-4">
            <div class="card bg-light border-0">
                <div class="card-body text-center">
                    ...
                    <h3 class="text-success mb-0"><?= count(array_filter($tasks, fn($t) => $t['type'] === 'Hướng dẫn đoàn')) ?></h3>
        ...
        <div class="col-md-4">
            <div class="card bg-light border-0">
                <div class="card-body text-center">
                    ...
                    <h3 class="text-warning mb-0"><?= count(array_filter($tasks, fn($t) => $t['type'] === 'Ghi chú đặc biệt')) ?></h3>
