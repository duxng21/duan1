        ...
        <div class="content-header row">
                ...
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">
                            <i class="feather icon-calendar"></i> Lịch xem tháng
                        </h2>
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Lịch tháng
                                </li>
                            </ol>
                        </div>
                    </div>
            ...
            <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                <div class="form-group breadcrum-right">
                    <a href="?act=hdv-lich-cua-toi" class="btn btn-secondary btn-sm">
                                    ...
                                    <form method="GET" class="row g-3 align-items-end">
                                        ...
                                        <div class="col-md-6 text-end">
                                            <button type="button" class="btn btn-outline-secondary"
                                                onclick="window.location.href='?act=hdv-xem-lich-thang&month=' + (new Date()).getMonth() + 1 + '&year=' + (new Date()).getFullYear()">
                                                ...
                                                for ($week = 0; $week < 6; $week++) {
                                                    ...
                                                    for ($dow = 0; $dow < 7; $dow++) {
                                                        if (($week == 0 && $dow < $first_day_of_week) || $day > $total_days) {
                                                            ...
                                                            ?>
                                                            <td class="p-2 <?= $cell_class ?>"
                                                                style="vertical-align: top; position: relative; cursor: <?= $has_events ? 'pointer' : 'default' ?>;"
                                                                <?php if ($has_events): ?> data-bs-toggle="modal"
                                                                    data-bs-target="#dayModal" onclick="showDayEvents(<?= $day ?>)"
                                                                <?php endif; ?>>
                                                                    ...
                                                                    <?php if ($has_events): ?>
                                                                        <?php foreach (array_slice($calendar_events[$day], 0, 2) as $schedule): ?>
                                                                            <div class="badge bg-success mb-1"
                                                                                style="display: block; font-size: 0.65rem; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mb-0">
                                        <i class="fas fa-list"></i> Danh sách tour tháng
                                ...
                                <div class="card-body">
                                    ...
                                    <?php else: ?>
                                        <div class="alert alert-info">
                                            <i class="fas fa-info-circle"></i> Không có tour nào được phân công trong tháng
                                            này
                                        </div>
                                    <?php endif; ?>
                                </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Tour ngày <span id="modalDay"></span>/<span
                                        id="modalMonth"><?= $month ?></span>/<span id="modalYear"><?= $year ?></span>
                                </h5>
