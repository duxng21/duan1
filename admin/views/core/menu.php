...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class="<?= isActive(['dashboard']) ? 'active' : '' ?> nav-item"><a href="?act=dashboard"><i
                        class="feather icon-home"></i><span class="menu-title"
                        data-i18n="Dashboard"><?php echo (function_exists('isGuide') && isGuide()) ? 'Trang chủ' : 'Trang chủ quản trị'; ?></span></a>
            </li>
